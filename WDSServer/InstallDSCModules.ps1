...
$githubrepo = 'https://raw.githubusercontent.com/JorgendG/cWDS'
Invoke-WebRequest -Uri "$githubrepo/master/cWDS.psd1" -OutFile 'C:\Program Files\WindowsPowerShell\Modules\cWDS\cWDS.psd1'
Invoke-WebRequest -Uri "$githubrepo/master/cWDS.psm1" -OutFile 'C:\Program Files\WindowsPowerShell\Modules\cWDS\cWDS.psm1'
