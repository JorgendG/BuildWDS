...
Import-WdsInstallImage -Path c:\wdsimages\installw10_19h2.wim -ImageName 'Windows Server 2019 Standard Evaluation (Desktop Experience)' -ImageGroup 'Windows 10'
Import-WdsInstallImage -Path c:\wdsimages\install2019.wim -ImageName 'Windows Server 2019 Standard Evaluation (Desktop Experience)' -ImageGroup 'Windows Server 2019'
