...
Invoke-Command -ComputerName hyperhyper -ScriptBlock {
    ...
    Invoke-Command -Session $sess -JobName { Import-WdsInstallImage -Path c:\wdsimages\install.wim -path c:\wdsimages\install.wim -Name 'Windows Server 2016 SERVERSTANDARD' -ImageGroup 'Windows Server 2016' }
